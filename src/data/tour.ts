...
export const itinerary: DaySchedule[] = [
  {
    ...
    attractions: [
      { zh: "抵達開羅機場，助理協助辦理落地簽", en: "Arrive Cairo, visa on arrival assistance", isActivity: true },
      {
        ...
        practicalTips: [
          "🕌 建議女士自備頭巾；穿太短可在門口租借阿拉伯袍（免費或小額費用，現場確認）",
          "👟 進清真寺需脫鞋，怕髒可在入口買一次性鞋套（約 5-10 EGP）",
        ],
      },
      {
        zh: "穆罕默德·阿里清真寺",
  ...
  },
  {
    ...
    attractions: [
      ...
      },
      {
        ...
        practicalTips: [
          "📷 鱷魚博物館允許拍照但禁閃光燈，導遊不得進入講解（以現場告示為準）",
...
export const importantNotes = [
  ...
  },
  {
    category: "行李",
    items: [
      "埃及內陸航班行李限制：托運 23 KG + 手提 7-8 KG 小包（視票種）",
    ],
  },
  {
    category: "行李遺失",
