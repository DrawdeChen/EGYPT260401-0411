      ...
      attractions: [
        {
          ...
          deepContent: {
            stories: [
              { title: "鯨魚谷的遠古秘密", text: "法尤姆附近的「鯨魚谷」（Wadi Al-Hitan）是 UNESCO 世界遺產，保存了 4,000 萬年前古代鯨魚從陸生哺乳動物演化為海洋生物的化石證據——這片沙漠曾是一片汪洋大海。" },
              { title: "法老的狩獵場", text: "古埃及第十二王朝的法老們在此建造了水利工程，將尼羅河水引入法尤姆窪地，創造了人工湖泊 Moeris。這裡曾是法老的皇家狩獵場和度假地，也是古埃及最富饒的農業區之一。" },
            ],
            highlights: [
              { icon: "🐋", text: "鯨魚谷（Wadi Al-Hitan）— UNESCO 世界遺產，露天化石博物館，可看到完整的古鯨魚骨架" },
              { icon: "🏺", text: "法尤姆肖像畫 — 這裡出土了世界上最早的寫實肖像畫（約 2,000 年前），比文藝復興早了一千多年" },
              { icon: "🌊", text: "Magic Lake — 湖水會隨光線變化顏色，從藍到綠到金色" },
            ],
            food: [
              { name: "法尤姆鹹魚（Fesikh）", desc: "法尤姆的傳統發酵鹹魚，味道強烈但是當地人的最愛，勇者可以挑戰" },
            ],
          },
        },
        {
          ...
          deepContent: {
            stories: [
              { title: "法老的人工湖", text: "加龍湖的前身是古埃及法老建造的 Moeris 湖，透過運河從尼羅河引水。古希臘歷史學家希羅多德親眼見過這座湖，讚嘆為「人類最偉大的工程之一」。如今湖面已大幅縮小，但仍是埃及最重要的濕地之一。" },
            ],
            highlights: [
              { icon: "🦅", text: "候鳥天堂 — 冬季有大量遷徙候鳥棲息，包括紅鶴、鵜鶘等" },
              { icon: "🏛️", text: "Qasr Qarun 神殿 — 湖西端有一座保存完好的托勒密時代神殿，遊客極少" },
            ],
            food: [],
          },
        },
    ...
    hiddenAttractions: [
      {
        ...
        deepContent: {
          stories: [
            { title: "史上最盛大的搬家：法老黃金遊行", text: "2021 年 4 月 3 日，22 具皇家木乃伊從舊埃及博物館遷入 NMEC，埃及政府舉辦了「法老黃金遊行」（Pharaohs' Golden Parade）——每具木乃伊各乘一輛特製金色戰車，沿尼羅河畔遊行 7 公里。全程有軍樂隊、馬隊護送，開羅全城封路，全球直播。這是法老們 3,000 年來第一次「出門」。" },
            { title: "拉美西斯二世的護照", text: "1974 年拉美西斯二世的木乃伊需要飛往巴黎修復。埃及政府為他簽發了一本護照——職業欄寫「國王（已故）」。他在巴黎受到了國家元首級的接機禮遇。現在這具木乃伊就在 NMEC。" },
          ],
          highlights: [
            { icon: "👑", text: "22 具皇家木乃伊 — 包括拉美西斯二世、哈特謝普蘇特女王、塞提一世等，是全世界最集中的法老遺體收藏" },
            { icon: "🏗️", text: "與 GEM 的區別 — GEM 聚焦古埃及，NMEC 涵蓋從史前到現代的完整文明史，兩者互補" },
            { icon: "🌊", text: "尼羅河景觀 — 博物館本身的現代建築設計+尼羅河景觀值得駐足" },
          ],
          food: [],
        },
      },
